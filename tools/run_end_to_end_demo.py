...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--morning-image", type=Path, default=PROJECT_ROOT / "data" / "simulation" / "Morning.png")
    parser.add_argument("--evening-image", type=Path, default=PROJECT_ROOT / "data" / "simulation" / "Evening.png")
